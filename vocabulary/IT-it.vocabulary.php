...
$MESSAGE['homepage']['main_content']['welcome'] = 'Benvenuto a Crossroads';
...
$MESSAGE['register']['fields']['gender_m'] = 'Maschile';
$MESSAGE['register']['fields']['gender_f'] = 'Femminile';
...
$MESSAGE['register']['welcome']['message'][4] = 'Benvenuto/a a Crossroads, viandante!
Siamo più che lieti di accoglierti nel nostro variopinto, folle Regno :)
Bando alle ciance ed ai formalismi, di seguito troverai qualche informazione utile per orientarti al meglio e cominciare al più presto a giocare con noi.

Innanzitutto, dalla mappa potrai facilmente notare che il continente di Hyle è grande. Molto grande.
Con un sacco di terre, posti ed anfratti diversi tra loro. Ma non temere: non è necessario conoscere subito tutta la ricchissima geografia di Hyle prima di cominciare a giocare. Almeno all’inizio, l’unico luogo che ti sarà necessario conoscere è [b]Crossroads[/b], la Capitale: qui si concentra la maggior parte del gioco (soprattutto per quanto concerne le role free), pertanto ti basterà dare un’occhiata ai diversi Quartieri presenti sulla mappa per avere una panoramica piuttosto rapida delle diverse chat disponibili. Potrai, inoltre, consultare il relativo documento nella sezione “[b]Luoghi del Continente[/b]” della documentazione: lì troverai tutte le informazioni che è necessario conoscere per chi intende muovere al meglio il proprio personaggio sul suolo della Capitale.

Rimanendo nell’ambito della documentazione, sebbene sia consigliabile armarsi di santa pazienza e leggerla poco a poco un po’ tutta (promettiamo che non è così noiosa come sembra, davvero!), ti suggeriamo di prestare particolare attenzione al “[b]Regolamento[/b]”: esso infatti raccoglie tutte le regole necessarie da conoscere prima di cominciare a giocare, e spiega in maniera esaustiva tutte le dinamiche di gioco che regolano questa landa.
Prima di buttarti a capofitto nel gioco, ricorda anche di prenderti qualche minuto per leggere lo [b]statuto[/b] inerente alla [b]razza[/b] che hai scelto per il tuo personaggio: sarà fondamentale per strutturare una scheda coerente e potrebbe anche darti qualche spunto interessante per la costruzione del suo background, ma non solo: una volta inquadrato al meglio il tuo personaggio, [u]ricordati di comunicare alla gestione l’[b]allineamento[/b][/u] che hai scelto per lui: provvederemo al più presto ad inserirlo nella tua scheda personale.

Ti ricordiamo infine che, per chiacchiere futili off game, meme stupidi e comunicazioni più rapide con la gestione, questa landa utilizza anche un canale esterno su [b]Discord[/b]. Non è strettamente necessario entrare a farne parte per poter vivere appieno l’esperienza di gioco, giacché tutto il necessario (anche per la comunicazione off) lo troverai comunque nella sezione del [b]Forum[/b] qui in land, tuttavia può essere un mezzo estremamente utile e pratico per trovare più in fretta supporto, aiuto creativo, informazioni o richieste di role (o, molto più semplicemente, anche solo per scambiare quattro chiacchiere con la nostra disponibile ed amorevole utenza).
A tua discrezione, ti lasciamo di seguito il link d’invito al nostro server Discord: saremo felici di accoglierti anche lì!

[b]https://discord.gg/jF5aKVEkbD[/b]

Per qualsiasi necessità, che sia per chiedere informazioni o qualunque altro tipo di supporto, ricordati che potrai sempre rivolgerti alla gestione scrivendo una missiva a Ren (ha la faccia burbera e borbottante, ma ti assicuriamo che in realtà è uno zuccherino) o a Theris (che sembra un po’ una biondina smorfiosetta, ma in verità ha un cuoricino buono come i biscotti di cui si abbuffa) o, in alternativa, alle nostre capacissime Guide e Master!

Ti auguriamo buon gioco, nella speranza che vorrai rimanere con noi anche in futuro!
Benvenuto nella Capitale!

A presto,
Lo Staff di Crossroads :)';
/* Errori */
$MESSAGE['register']['error']['name_taken'] = 'Il nome scelto è già in uso.';
$MESSAGE['register']['error']['email_taken'] = 'Questa e-mail è già in uso.';
...
$MESSAGE['interface']['logged_users']['logged_in'] = 'Entrano';
$MESSAGE['interface']['logged_users']['logged_out'] = 'Escono';
/* Pannello informazioni */
$MESSAGE['interface']['meteo']['title'] = 'Meteo';
$MESSAGE['interface']['meteo']['status'][0] = '<img src="imgs/meteo/sole.png">';
//$PARAMETERS['menu']['user_services']['text'][0] = 'Sole'; 
$MESSAGE['interface']['meteo']['status'][1] = '<img src="imgs/meteo/variabile.png">';
//$PARAMETERS['menu']['user_services']['text'][1] = 'Variabile';
$MESSAGE['interface']['meteo']['status'][2] = '<img src="imgs/meteo/nuvoloso.png">';
//$PARAMETERS['menu']['user_services']['text'][2] = 'Nuvoloso';
$MESSAGE['interface']['meteo']['status'][3] = '<img src="imgs/meteo/pioggia.png">';
//$PARAMETERS['menu']['user_services']['text'][3] = 'Pioggia';
$MESSAGE['interface']['meteo']['status'][4] = '<img src="imgs/meteo/neve.png">';
//$PARAMETERS['menu']['user_services']['text'][4] = 'Neve';
...
$MESSAGE['interface']['sheet']['box_title']['portrait'] = 'Caratteristiche';
$MESSAGE['interface']['sheet']['box_title']['profile'] = 'Generalità';
...
$MESSAGE['interface']['sheet']['profile']['role'] = 'Incarico';
...
$MESSAGE['interface']['sheet']['profile']['status'] = 'Segni particolari';
$MESSAGE['interface']['sheet']['profile']['status2'] = 'Note Fato';
...
$MESSAGE['interface']['sheet']['modify_form']['prestavolto'] = 'Nome del prestavolto';
$MESSAGE['interface']['sheet']['modify_form']['relationships'] = 'Affetti [ larghezza massima: 600 pixel ]';
$MESSAGE['interface']['sheet']['modify_form']['background'] = 'Background [ larghezza massima: 600 pixel ]';
$MESSAGE['interface']['sheet']['modify_form']['online_state'] = 'Messaggio da mostrare nell\'elenco esteso degli online';
$MESSAGE['interface']['sheet']['modify_form']['url_img'] = 'URL immagine [ 215x500 pixel ]';
$MESSAGE['interface']['sheet']['modify_form']['url_img_chat'] = 'URL immagine di chat [ dimensioni massime: 90x90 pixel - vietate le gif ]';
$MESSAGE['interface']['sheet']['modify_form']['url_media'] = 'URL media [ Mp3 ]';
$MESSAGE['interface']['sheet']['modify_form']['block_media'] = 'Disabilita tutti i suoni nel gioco';
$MESSAGE['interface']['sheet']['modify_form']['status'] = 'Segni particolari';
$MESSAGE['interface']['sheet']['modify_form']['status2'] = 'Note Fato';
...
$MESSAGE['interface']['messages']['date'] = 'Ricevuta il';
...
$MESSAGE['interface']['messages']['new'] = 'Scrivi una nuova ' . strtolower($PARAMETERS['names']['private_message']['sing']);
$MESSAGE['interface']['messages']['sent'] = ' inviata';
...
$MESSAGE['interface']['messages']['erase_all'] = 'Elimina tutte le missive già lette';
$MESSAGE['interface']['messages']['erase_selected'] = 'Elimina le missive selezionate';
$MESSAGE['interface']['messages']['erased'] = ' eliminata';
$MESSAGE['interface']['messages']['all_erased'] = ' eliminate';
...
$MESSAGE['interface']['messages']['go_back'] = 'Torna all\'elenco delle ' . strtolower($PARAMETERS['names']['private_message']['plur']) . '.';
/* Forum */
$MESSAGE['interface']['forums']['topic']['new_posts']['sing'] = 'Nuova Missiva';
$MESSAGE['interface']['forums']['topic']['new_posts']['plur'] = 'Nuove Missive';
$MESSAGE['interface']['forums']['topic']['title'] = 'Discussione';
...
$MESSAGE['interface']['forums']['warning']['topic_not_exists'] = 'Questa discussione non esiste.';
$MESSAGE['interface']['forums']['topic']['last_post'] = 'Ultima';
$MESSAGE['interface']['forums']['link']['back'] = 'Torna alle Bacheche';
$MESSAGE['interface']['forums']['link']['forum'] = 'Torna all\'elenco.';
$MESSAGE['interface']['forums']['link']['topic'] = 'Torna all\'argomento.';
$MESSAGE['interface']['forums']['link']['new_topic'] = '+ Nuovo Topic';
...
$MESSAGE['interface']['forums']['delete']['title'] = 'Cancella post';
$MESSAGE['interface']['forums']['delete']['ask'] = 'Sei sicuro di voler cancellare questo post?';
/* Tipi forum*/
$MESSAGE['interface']['forums']['type'][0] = 'In Game';
$MESSAGE['interface']['forums']['type'][1] = 'Off Game';
$MESSAGE['interface']['forums']['type'][2] = 'Di ' . strtolower($PARAMETERS['names']['race']['sing']) . '';
$MESSAGE['interface']['forums']['type'][3] = 'Di ' . strtolower($PARAMETERS['names']['guild_name']['sing']) . '';
$MESSAGE['interface']['forums']['type'][4] = 'Master';
$MESSAGE['interface']['forums']['type'][5] = 'Gestione';
/*Servizi bancari*/
...
$MESSAGE['interface']['administration']['forums']['link']['new'] = 'Crea un nuovo ' . strtolower($PARAMETERS['names']['forum']['sing']);
...
$MESSAGE['interface']['administration']['forums']['type']['info'] = 'Gli admin possono comunque accedere a tutti i ' . $PARAMETERS['names']['forum']['plur'] . ' come moderatori';
...
$MESSAGE['interface']['administration']['forums']['not_exists'] = 'Forum non trovato';
...
$MESSAGE['interface']['administration']['races']['tripla'] = 'Immagine dettagli';
...
$MESSAGE['interface']['user']['name']['email'] = 'Inserire la mail di registrazione per conferma';
...
$MESSAGE['status_pg']['availability'][0] = 'Non disponibile';
$MESSAGE['status_pg']['availability'][1] = 'Disponibile';
...
$MESSAGE['chat']['tag']['info']['msg'] = 'Messaggio';
...
$MESSAGE['chat']['commands']['item'] = 'Oggetto';
...
$MESSAGE['interface']['administration']['news']['title'] = 'Titolo';
