...
<div class="page_title_info">
   ...
   <h2><marquee onmouseover="this.stop()" onmouseout="this.start()" direction="left" scrollamount="3" class="stato_luogo">&nbsp;
   <?php echo gdrcd_filter('out', $nome_luogo) ; ?></marquee></h2>
 </div></div>
...
<?php if ((isset($record['stato'])===TRUE)||(isset($record['descrizione'])===TRUE)){
		 ...
		 echo '<div class="box_stato_luogo"><div class="box_stato_luogo_marquee"><marquee onmouseover="this.stop()" onmouseout="this.start()" direction="left" scrollamount="3" class="stato_luogo">&nbsp;'.$MESSAGE['interface']['maps']['Status'].': '.gdrcd_filter('out',$record['stato']).' -  '.gdrcd_filter('out',$record['descrizione']).'</marquee></div></div>'; } else { echo '<div class="box_stato_luogo">&nbsp;</div>';
		 }?>
...
<iframe src ="../imgs/fasilunari/fasiluna1.htm" frameborder="0" scrolling="no" height="45" width="45" style="display: inline">
   </iframe>
<p style="text-align:center; width: 90px; margin:-22px 0px 0px 50px; position: absolute; padding:0px; color: #0A1228; font-style: italic; font-size: 10px; font-weight: bold;">
  <!--CODICE VENTO-->
