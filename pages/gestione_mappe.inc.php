<div class="pagina_gestione_mappe">
	...
	if ($_SESSION['permessi'] < ADMIN) {
		...
		<div class="page_title">
			...
			<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/gest_mappe.png"></div>
		</div>
			...
			if (
				...
				<div class="panels_box">
					<form action="main.php?page=gestione_mappe" method="post" class="form_gestione">
						...
						<div class='form_field'>
							<input type="checkbox" name="mobile" <?php if ($loaded_record['mobile'] == 1) { ?> checked="checked"
									<?php } ?> value="is_mobile" />
						</div>
						<div class='form_info'>
					...
					<div class="elenco_record_gestione">
						<table>
							...
							<tr>
								...
								<td class="casella_titolo">
									<div class="titoli_elenco"><?php echo gdrcd_filter('out', $MESSAGE['interface']['administration']['maps']['position']); ?></div>
								</td>
								<td class="casella_titolo">
									<div class="titoli_elenco">
										<?php echo gdrcd_filter('out', $MESSAGE['interface']['administration']['maps']['is_mobile']); ?>
									...
									<td class="casella_controlli"><!-- Iconcine dei controlli -->
										...
										<div class="controlli_elenco">
											<div class="controllo_elenco">
												<form class="opzioni_elenco_record_gestione" action="main.php?page=gestione_mappe"
													method="post">
													<input type="hidden" name="id_record"
				...
				<div class="pager">
					...
					for ($i = 0; $i <= floor($totaleresults / $PARAMETERS['settings']['records_per_page']); $i++) {
						if ($i != gdrcd_filter('num', $_REQUEST['offset'])) { ?>
								<a href="main.php?page=gestione_mappe&offset=<?php echo $i; ?>">
									<?php echo $i + 1; ?>
								</a>
								<?php } else {
							echo ' ' . ($i + 1) . ' ';
