...
<div class="link_menu">
<a href="main.php?dir=-1" style="margin-top: 0px; margin-left: 30px; display: inline; float: left;" id="link_menu_refresh" onmouseover="nmenu6_over_button()" onmouseout="nmenu6_up_button()"><img src="themes/tok1/imgs/menu/aggiorna.png" alt="Aggiorna" title="Aggiorna" name="nmenu6_buttonOne"></a>
