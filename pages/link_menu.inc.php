<div class="pagina_link_menu">
  ...
  if ($PARAMETERS['mode']['gotomap_list'] == 'ON' && empty($params['no_gotomap_list'])) {
    ...
    if (gdrcd_query($result, 'num_rows') > 0) {
      ...
      <select id="gotomap" onchange="self.location.href=this.value;">
        ...
        ?>
          <option value="main.php?page=mappaclick&map_id=<?php echo $splitInfoMap[1]; ?>" <?php echo ($_SESSION['mappa'] == $splitInfoMap[1] && $_SESSION['luogo'] == -1) ? ' selected="selected"' : ''; ?> class="map">
  ...
  <div class="link_menu">
    <a href="javascript:window.location.href=window.location.href"
      style="margin-top: 0px; margin-left: 30px; display: inline; float: left;" id="link_menu_refresh"
      onmouseover="nmenu6_over_button()" onmouseout="nmenu6_up_button()"><img src="themes/tok1/imgs/menu/aggiorna.png"
        alt="Aggiorna" title="Aggiorna" name="nmenu6_buttonOne"></a>
