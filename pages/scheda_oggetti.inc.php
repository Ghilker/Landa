      ...
      <div class="page_body">
                ...
                <tr>
                  ...
                  <td class="casella_elemento">
                    <div class="inventario_nome">
                      <?php echo gdrcd_filter('out', $record['nome_oggetto']); ?>
                    </div>
                    <div class="inventario_img">
                      <img
                        src="themes/<?php echo $PARAMETERS['themes']['current_theme'] ?>/imgs/items/<?php echo gdrcd_filter('out', $record['urlimg']); ?>" />
                    </div>
                    ...
                    <div class="inventario_quantita"><?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['items']['list']['pts'] . ": " . $record['numero']); ?>
                    </div>
                  </td>
                  <!-- Bonus -->
                  <td class="casella_elemento">
                    ...
                    <div class="inventario_riga_descrizione">
                      ...
                      <div>
                        ...
                        <form action="main.php?page=scheda_oggetti" method="post">
                          <input type="hidden" value="commenta" name="op" />
                          ...
                          <input type="hidden" value="<?php echo $_REQUEST['pg']; ?>" name="pg" />
                        </form>
                      </div>
                      <?php } //else if ?>
                  </td>
                      ...
                      <div class="form_gioco">
                        ...
                        <?php if ($record['ubicabile'] > 0) { ?>
                          ...
                          <form action="main.php?page=scheda_equip" method="post">
                            <input type="hidden" value="in_zaino" name="op" />
                            <input type="hidden" value="<?php echo $record['id_oggetto']; ?>" name="id_oggetto" />
                            <input type="submit"
        ...
        <div class="link_back">
          <a href="main.php?page=scheda_equip&pg=<?php echo gdrcd_filter('url', $_REQUEST['pg']); ?>">
            <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['items']['list']['put_in']) . '.'; ?>
          </a><br />
