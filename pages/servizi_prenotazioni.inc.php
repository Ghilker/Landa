...
<div class="pagina_servizi_prenotazioni">
	...
	<div class="page_title">
		...
		<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/stanzeprivate.png"></div>
	</div>
	...
	<div class="page_body">
		...
		if (isset($_POST['op']) === FALSE) { ?>
			<div class="form_gioco">
				...
				if ((gdrcd_query($result, 'num_rows') == 0) || ($PARAMETERS['mode']['privaterooms'] == 'OFF')) {
					...
					<form action="main.php?page=servizi_prenotazioni" method="post">
		...
		if (gdrcd_filter('get', $_POST['op']) == 'book') {
			...
			<div class="panels_link">
				<a href="main.php?page=servizi_prenotazioni">
					<?php echo gdrcd_filter('out', $MESSAGE['interface']['hotel']['back']); ?>
				</a>
			</div>
