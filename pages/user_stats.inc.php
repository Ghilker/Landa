...
<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/statistiche_sito.png"></div>
...
<div class="page_body">
		...
		<?php
		$row=gdrcd_query("SELECT COUNT(*) AS stat FROM personaggio WHERE permessi = ".MASTER."");?>
		<tr>
		<td class="casella_elemento"><div class="elementi_elenco">
		...
		<?php
		$row=gdrcd_query("SELECT COUNT(*) AS stat FROM personaggio WHERE permessi >= ".ADMIN."");?>
		<tr>
		<td class="casella_elemento"><div class="elementi_elenco">
		    <?php echo gdrcd_filter('out',$PARAMETERS['names']['admin']['plur']).': '; ?>
		</div></td>
		<td class="casella_elemento"><div class="elementi_elenco">
		<?php echo $row['stat']; ?>
		</div></td>
