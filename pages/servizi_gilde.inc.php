...
<div class="pagina_servizi_gilde">
	...
	<div class="page_title">
		...
		<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/gilde.png"></div>
	</div>
...
if (isset($_REQUEST['id_gilda']) === FALSE) {
  ...
  ?>
				...
				<table>
					<tr>
						<td colspan="4">
							<!-- Titoletto -->
							<div class="capitolo_elenco">
								<?php echo gdrcd_filter('out', $MESSAGE['interface']['guilds']['roles_title']['plur']); ?>
							</div>
						</td>
					<tr>
					<tr>
					...
					<tr>
						<td>
							<div class="icone_elenco">
								<?php if ($row['capo'] == 1) { ?><img src="imgs/icons/crown1.gif" />
								<?php } else { ?>&nbsp;
								<?php } ?>
							</div>
						</td>
				...
				<table>
					<tr>
						<td colspan="4">
							<!-- Titoletto -->
							<div class="capitolo_elenco">
								<?php echo gdrcd_filter('out', $MESSAGE['interface']['guilds']['members']); ?>
							</div>
						</td>
					<tr>
					<tr>
					...
					<tr>
						...
						<td>
							<div class="elementi_elenco">
								<a
									href="main.php?page=scheda&pg=<?php echo gdrcd_filter('out', $row['personaggio']); ?>">
	...
	if (empty($statuto['statuto']) === FALSE) { ?>
		...
		<div class="link_back">
			<a href="main.php?page=servizi_gilde">
				<?php echo gdrcd_filter('out', $MESSAGE['interface']['guilds']['back']); ?>
			</a>
		</div>
