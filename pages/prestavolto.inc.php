...
<div id="maincontent">
  <div class="output">
    ...
    <div style="text-align: center;font-size: 1em; width:600px; text-align:justify; margin:auto;">
      ...
      Fai una ricerca nel form sottostante mettendo o il nome o il cognome o la saga da cui è preso il pv che hai scelto
      e nel caso non sia presente, <u>comunicare la richiesta nel topic <em>"Richieste e modifiche prestavolti"</em> in
        <em>Forum</em></u>.<br />
      ...
      <ul style="margin-left:15px;">
        ...
        <li>Sono consentiti <strong>Original Characters</strong>, purchè rispecchino lo stile Manga / Anime /
          Otome-Games / Manwha.</li>
        <li>Il patrocinio del proprio PV verrà perso dopo <strong>2 mesi</strong> di assenza ingiustificata.</li>
        <li><strong>Non sono consentiti "doppi" pv</strong>, a meno che i due pg non siano gemelli o sosia
          <em>(quest'informazione è da comunicare allo staff)</em>.</li>
      </ul>
      <br />
      <br /><br />
    </div>
    ...
    <div class="elenco_record_gioco" style="width:98%; text-align:center;">
      ...
      <div style="font-size: 1em; width:50%; text-align:justify; margin:auto;">
        <!--10%-->
        <form action="" method="post" onsubmit="return false" ;>
          <!-- HDY: <form action="" method="post"> -->
          ...
          <div class='form_submit' style="margin-left: 95%; margin-top: -28px; margin-bottom: 40px;">
            <!-- <input name="submit_search" type="submit" value="Cerca" class="form_submit" /> -->
            <!--180%-->
            <input name="submit_search" onclick="cerca()" type="submit" value="Cerca" class="form_submit"
              style="width:80px;" />
          </div>
          <!-- <div class='form_submit' style="margin-left: 95%; margin-top: -28px; margin-bottom: 40px;">
...
echo "<script type=" . '"text/javascript"' . ">" .
  ...
  "</script>"; ?>
      ...
      <div class="elenco_record_gioco">
        <!--style="display:none" NASCONDE IL LISTONE FISSO DI PV-->
        <div id="result_table">
        </div>
        <?php
  while ($row = gdrcd_query($result, 'fetch')) { ?>
        ...
        <div>
          <table style="margin-left:auto; margin-right:auto;">
            ...
            <tr class="pv" style="display:none">
              <td style="width: auto;">
                <img src="<?php echo gdrcd_bbcoder(gdrcd_filter('out', $row['url_img_chat'])); ?>"
              ...
              <td style="width: 50%;">
                <div style="font-size: 1.2em; color: #dadada;">
                  ...
                  <a href="main.php?page=messages_center&newmessage=yes&reply_dest=<?php echo gdrcd_filter('url', $record['nome']); ?>"
                    ...
                    <img class="presenti_ico2" src="imgs/icons/mail_write.png" alt="E-Mail"
                      href="main.php?page=messages_center&newmessage=yes&reply_dest=<?php echo gdrcd_filter('url', $record['nome']); ?>" />
                    <?php } else {
      echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['send_message_to']['send']) . ' ' . gdrcd_filter('out', strtolower($PARAMETERS['names']['private_message']['sing'])) . ' ' . gdrcd_filter('out', $MESSAGE['interface']['sheet']['send_message_to']['to']) . ' ' . gdrcd_filter('out', $record['nome']);
                  ...
                  <div style="font-size: 1em;">
                    pv: <u style="color: #CC9933; text-transform: capitalize;">
