    ...
    if (isset($_REQUEST['pg']) === FALSE) {
      ...
      if (gdrcd_query($result, 'num_rows') == 0) {
        ...
        <div class="page_title">
          <h2>
            <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['log']['page_name']); ?>
          </h2>
        </div>
                  ...
                  <tr>
                    <td class="casella_elemento">
                      <div class="elementi_elenco">
                        <?php echo gdrcd_filter('out', gdrcd_format_date($record['data_evento']) . ' ' . gdrcd_format_time($record['data_evento'])); ?>
                      </div>
                    </td>
                    <td class="casella_elemento">
                      <div class="elementi_elenco">
                        <?php echo gdrcd_filter('out', $record['descrizione_evento']); ?>
                      </div>
                    </td>
                  </tr>
                  <?php } //while
                  ...
                  <table>
                    ...
                    <?php while ($record = gdrcd_query($result, 'fetch')) { ?>
                      <tr>
                        <td class="casella_elemento">
                          <div class="elementi_elenco">
                            <?php echo gdrcd_filter('out', gdrcd_format_date($record['spedito']) . ' ' . gdrcd_format_time($record['spedito'])); ?>
                          </div>
                        </td>
                        <td class="casella_elemento">
                          <div class="elementi_elenco">
                            <?php echo '[<a href="main.php?page=scheda&pg=' . gdrcd_filter('out', $record['destinatario']) . '"  >' . gdrcd_filter('out', $record['destinatario']) . '</a>]: ' . gdrcd_filter('out', $record['testo']); ?>
                          </div>
                        </td>
                      </tr>
                      <?php } //while
