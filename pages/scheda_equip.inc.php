<div class="pagina_scheda_equip">
	...
	if (isset($_REQUEST['pg']) === FALSE) {
		...
		if (gdrcd_query($result, 'num_rows') == 0) {
			...
			<div class="page_title">
				<h2>
					<?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['items']['zaino']); ?>
				</h2>
			</div>
										...
										<?php if (($_SESSION['login'] == $_REQUEST['pg']) || ($_SESSION['permessi'] >= MASTER)) { ?>
											<div class="form_gioco">
												...
												<form action="main.php?page=scheda_equip" method="post">
													<input type="hidden" value="<?php echo gdrcd_filter('out', $_REQUEST['pg']); ?>"
														name="pg" />
													<input type="hidden"
													...
													<input type="hidden" value="<?php echo $record['id_oggetto']; ?>"
														name="id_oggetto" />
													<input type="submit"
