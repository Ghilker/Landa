	...
	$result = gdrcd_query($query, 'result'); ?>
		<div class="elenco_record_gioco">
			<table>
				<tr>
					<td>
						<div class="titoli_elenco">Immagine</div>
					</td>
					<td class="casella_titolo" colspan="1">
						<div class="titoli_elenco">
							<?php echo gdrcd_filter('out', $MESSAGE['interface']['job']['job']); ?>
						</div>
					</td>
					<td class="casella_titolo">
						<div class="titoli_elenco">
							<?php echo gdrcd_filter('out', $MESSAGE['interface']['job']['pay']); ?>
						</div>
					</td>
					<td class="casella_titolo">
						<div class="titoli_elenco">
							<?php echo gdrcd_filter('out', $MESSAGE['interface']['job']['controls']); ?>
						</div>
					</td>
				</tr>
				...
				<tr>
					<td class="casella_elemento_img" rowspan="2">
					...
					<td class="casella_elemento" style="min-width:150px;">
						<div class="elementi_elenco">
							<?php echo $row['stipendio'] . ' ' . gdrcd_filter('out', $PARAMETERS['names']['currency']['plur']); ?>
						</div>
					</td>
			...
			if ($lavoro == $row['id_ruolo']) { ?>
				...
				echo '&nbsp;';
								...
								<input type="hidden" name="nome_lavoro"
			...
			echo '&nbsp;';
			  ...
			  <tr>
				<td class="casella_elemento" colspan="2"><div class="elementi_elenco"><?php echo $row['descrizione']; ?>
						</div>
					</td>
				</tr>
				<tr>
...
?>
		<div class="link_back">
			<a href="main.php?page=servizi_lavoro">
				<?php echo gdrcd_filter('out', $MESSAGE['interface']['job']['back']); ?>
			</a>
		</div>
