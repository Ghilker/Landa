...
<div class="page_title">
   ...
   <div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/mestieri.png"></div>
</div>
...
if(isset($_POST['op'])===FALSE){  
  	    ...
  	    $query="SELECT nome_ruolo, immagine, stipendio, id_ruolo, descrizione FROM ruolo WHERE gilda=-1 ORDER BY nome_ruolo";
	    $result=gdrcd_query($query, 'result');?>
		<div class="elenco_record_gioco">
		<table>
		<tr>
        <td><div class="titoli_elenco">Immagine</div></td>
		<td class="casella_titolo" colspan="1"><div class="titoli_elenco"><?php echo gdrcd_filter('out',$MESSAGE['interface']['job']['job']); ?></div></td>
	    ...
	    <?php while($row=gdrcd_query($result, 'fetch')){ ?>
		    ...
		    <!--table class="lavori_box" border="1"--><tr>
			  <td class="casella_elemento_img" rowspan="2"><div class="icone_elenco"><img class="" src="themes/<?php echo $PARAMETERS['themes']['current_theme'];?>/imgs/guilds/<?php echo $row['immagine']; ?>"/></div></td>
		      <td class="casella_elemento"><div class="elementi_elenco"><?php echo $row['nome_ruolo']; ?></div></td>
			  <td class="casella_elemento" style="min-width:150px;"><div class="elementi_elenco"><?php echo $row['stipendio'].' '.gdrcd_filter('out',$PARAMETERS['names']['currency']['plur']); ?></div></td>
		      <td  class="casella_controlli" rowspan="2"> 
			  ...
			  <tr>
				<td class="casella_elemento" colspan="2"><div class="elementi_elenco"><?php echo $row['descrizione']; ?></div></td>
			  </tr>
              <tr><td> </td></tr>
        <?php }//while 
