<div class="pagina_gestione">
	...
	<div class="page_title">
		<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/documenti.png"></div>
	</div>
	<div class="page_body">
		<?php
...
<?php /*HELP: Il menu viene generato automaticamente attingendo dalle informazioni contenute in config.inc.php. 
 ...
 Per realizzare un menu di altro tipo suggeriamo di commentare o cancellare il contenuto di questa pagina e 
 sostituirlo con il codice del nuovo menu. */?>