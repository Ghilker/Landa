<div class="pagina_gestione_manutenzione">
	...
	if ($_SESSION['permessi'] < GESTORE) {
		...
		<div class="page_title">
			...
			<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/manutenzione.png"></div>
		</div>
				...
				<div class="panels_box">
					<form action="main.php?page=gestione_manutenzione" method="post" class="form_gestione">
						...
						<div class='form_field'>
							<select name="mesi" ?>
								<?php for ($i = 0; $i <= 12; $i++) { ?><option value="<?php echo $i; ?>">
										<?php echo $i . ' ' . gdrcd_filter('out', $MESSAGE['interface']['administration']['maintenance']['months']); ?>
									</option>
									<?php } ?>
							</select>
						</div>
