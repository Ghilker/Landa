...
<?php /*Form di inserimento/modifica*/
    ...
    <form action="main.php?page=gestione_luoghi"
		  ...
		  <div class='form_field'>  
		    <textarea name="descrizione_dettagliata"><?php echo gdrcd_filter('out',$loaded_location['descrizione_dettagliata']); ?></textarea>
          </div>
