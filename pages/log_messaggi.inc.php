<div class="pagina_gestione_razze">
	...
	if (($_SESSION['permessi'] < ADMIN) || ($PARAMETERS['mode']['spymessages'] != 'ON')) {
		...
		<div class="page_title">
			...
			<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/log_messaggi.png"></div>
		</div>
				...
				<div class="pager">
					...
					for ($i = 0; $i <= floor($totaleresults / $PARAMETERS['settings']['records_per_page']); $i++) {
						if ($i != $_REQUEST['offset']) { ?>
								<a href="main.php?page=log_messaggi&op=view&pg=<?php echo $_REQUEST['pg']; ?>&offset=<?php echo $i; ?>">
									<?php echo $i + 1; ?>
								</a>
								<?php } else {
							echo ' ' . ($i + 1) . ' ';
