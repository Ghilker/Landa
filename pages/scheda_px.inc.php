...
?>
   ...
   <div class="page_title">
      <h2>
         <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['px']['page_name']); ?>
      </h2>
   </div>

   <?php /* Assegnamento PX*/
      if ($_POST['op'] == "assegna") {
         if ((is_numeric($_POST['px']) === TRUE) && ($_SESSION['permessi'] >= MASTER)) {
         ...
         <div class="elenco_record_gioco">
            <table>
               ...
               <tr>
                  ...
                  <td class="casella_elemento">
                     <div class="elementi_elenco">
                        <?php echo gdrcd_filter('out', gdrcd_format_date($record['data_evento'])); ?>
                     </div>
                  </td>
                  <td class="casella_elemento">
                     <div class="elementi_elenco">
...
?>
         ...
         <div class="form_gioco">
            <form action="main.php?page=scheda_px" method="post">
               <div class="form_label">
                  <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['px']['why']); ?>
               </div>
               <div class="form_field"><input name="causale" /></div>
               <div class="form_label">
                  <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['px']['px']); ?>
               </div>
