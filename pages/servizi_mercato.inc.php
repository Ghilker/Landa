...
if ((isset($_POST['op'])===FALSE)&&(isset($_REQUEST['op'])===FALSE)){ 
	...
	<table>
	   <!-- Intestazione tabella -->
		 ...
		 <tr>
		   <td  class=""><div class="link_menu_gestione">
...
<?php if ($_REQUEST['op']=='visit') { /*Elenco oggetti*/
	...
	if ($numresults>0){ ?>
       ...
       <table>
	      <!-- Intestazione tabella -->
          <tr>
		     <td class="casella_titolo"><div class="titoli_elenco_oggetto"><?php echo gdrcd_filter('out',$MESSAGE['interface']['market']['item']); ?></div></td>   
			 ...
			 <td class="casella_titolo"><div class="titoli_elenco_descrizione"><?php echo gdrcd_filter('out',$MESSAGE['interface']['market']['more']); ?></div></td>
		     <td class="casella_titolo"><div class="titoli_elenco_prezzo"><?php echo gdrcd_filter('out',$MESSAGE['interface']['market']['price']); ?></div></td>
		  </tr>
		  <!-- Record -->
          <?php while ($row=gdrcd_query($result, 'fetch')){ ?>
	      <tr>
