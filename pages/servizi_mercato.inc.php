...
?>
	...
	<div class="page_title">
		<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/centro_commerciale.png"></div>
	</div>
	...
	<div class="elenco_esteso">
		<div class="elenco_record_gioco">
			<table>
				...
				<tr>
					<td class="">
						<div class="link_menu_gestione">
							<a
								href="main.php?page=servizi_mercato&op=visit&what=<?php echo gdrcd_filter('out', $row['cod_tipo']); ?>">
	...
	<table>
		...
		<tr>
			<td class="casella_titolo">
				<div class="titoli_elenco_oggetto">
					<?php echo gdrcd_filter('out', $MESSAGE['interface']['market']['item']); ?>
				</div>
			</td>
			<!-- <td class="casella_titolo"><div class="titoli_elenco_parametri"><?php echo gdrcd_filter('out', $MESSAGE['interface']['market']['bonus']); ?></div></td>  -->
			<td class="casella_titolo">
				<div class="titoli_elenco_descrizione">
					<?php echo gdrcd_filter('out', $MESSAGE['interface']['market']['more']); ?>
				</div>
			</td>
			<td class="casella_titolo">
				<div class="titoli_elenco_prezzo">
					<?php echo gdrcd_filter('out', $MESSAGE['interface']['market']['price']); ?>
				</div>
			</td>
		</tr>
		<!-- Record -->
		...
		<tr>
			<td class="casella_elemento_img">
				...
				<div class="inventario_quantita">
					<?php echo $MESSAGE['interface']['market']['stock'] . ': ' . $row['numero']; ?>
				</div>
			</td>
			<!--  <td class="casella_elemento_parametri">
			...
			<div class="inventario_riga_proprieta">
               ...
               <div style="float: right; clear: right;">
				...
				echo $MESSAGE['interface']['market']['no_charges'];
					...
					<td class="casella_elemento_descrizione">
						<div class="inventario_nome">
							<?php echo $row['nome']; ?>
						</div>
							...
							<div class="form_gioco">
								<form action="main.php?page=servizi_mercato" method="post">
									...
									<div class='form_submit'>
										<input type="submit" name="butt" <?php if ($money < $row['costo']) {
				echo 'disabled
											';
			} ?>
										value="
										<?php echo gdrcd_filter('out', $MESSAGE['interface']['market']['buy']); ?>" />
...
<a
	href="main.php?page=servizi_mercato&op=visit&what=<?php echo gdrcd_filter('out', $_REQUEST['what']); ?>&offset=<?php echo $i; ?>">
	<?php echo $i + 1; ?>
</a>
<?php } //for
	} //if ?>
