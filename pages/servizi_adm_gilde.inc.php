...
<div class="pagina_servizi_adm_gilde">
	...
	<div class="page_body">
		...
		if (isset($_POST['op']) === FALSE) { ?>
			...
			<div class="link_back">
				<a href="main.php?page=servizi_adm_gilde">
					<?php echo gdrcd_filter('out', $MESSAGE['interface']['adm_guids']['back']); ?>
				</a>
			</div>
		...
		if (gdrcd_filter('get', $_POST['op']) == 'hire') {
			...
			<div class="panels_link">
				<a href="main.php?page=servizi_adm_gilde">
					<?php echo gdrcd_filter('out', $MESSAGE['interface']['adm_guilds']['back']); ?>
				</a>
			</div>
