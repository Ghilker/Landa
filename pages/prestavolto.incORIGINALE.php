...
<div style="text-align: center;font-size: 1em;">
  ...
  Controlla se nella lista c'è il prestavolto che vorresti utilizzare, nel caso sei pregato di cambiarlo per non
  generare un "doppio".<br />
  Per segnalare il tuo prestavolto, dalla tua scheda clicca su "modifica", inserisci nome e cognome del prestavolto
  nella terza casella e salva il tutto.<br />
  Grazie!<br /><br />
        ...
        <tr>
          ...
          <td style="width: 50%;">
            <div style="font-size: 1.2em; color: #dadada;">
              ...
              <br />
              <a href="popup.php?page=messages_center&newmessage=yes&reply_dest=<?php echo gdrcd_filter('url', $record['nome']); ?>"
                class="link_invia_messaggio">
                <?php if (empty($PARAMETERS['names']['private_message']['image_file2']) === FALSE) { ?>
                <img class="presenti_ico2" src="imgs/icons/mail_new3.png" alt="E-Mail"
                  href="popup.php?page=messages_center&newmessage=yes&reply_dest=<?php echo gdrcd_filter('url', $record['nome']); ?>" />
                <?php } else {
