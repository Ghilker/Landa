<div class="pagina_gestione_abilita">
	...
	if ($_SESSION['permessi'] < GESTORE) {
		...
		<div class="page_title">
			...
			<div style="margin-top: 15px; margin-bottom: 20px"><img src="/imgs/gest_abilita.png"></div>
		</div>
						...
						<div class='form_field'>
							<select name='id_razza'>
								...
								while ($raz = gdrcd_query($result, 'fetch')) { ?>
									<option value="<?php echo $raz['id_razza']; ?>" <?php if ($loaded_record['id_razza'] == $raz['id_razza']) {
									   echo 'SELECTED';
								   } ?>>
					...
					<div class="elenco_record_gestione">
						<table>
							...
							<tr>
								...
								<td class="casella_titolo">
									<div class="titoli_elenco"><?php echo gdrcd_filter('out', $MESSAGE['interface']['administration']['skills']['car']); ?></div>
								</td>
								<td class="casella_titolo">
									<div class="titoli_elenco">
									...
									<td class="casella_controlli"><!-- Iconcine dei controlli -->
										...
										<div class="controlli_elenco">
											<div class="controllo_elenco">
												<form class="opzioni_elenco_record_gestione" action="main.php?page=gestione_abilita"
													method="post">
				...
				<div class="pager">
					...
					for ($i = 0; $i <= floor($totaleresults / $PARAMETERS['settings']['records_per_page']); $i++) {
						if ($i != gdrcd_filter('num', $_REQUEST['offset'])) { ?>
								<a href="main.php?page=gestione_abilita&offset=<?php echo $i; ?>">
									<?php echo $i + 1; ?>
								</a>
								<?php } else {
							echo ' ' . ($i + 1) . ' ';
