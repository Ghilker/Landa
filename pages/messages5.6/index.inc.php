...
<div class="elenco_record_gioco">
            ...
            <td>
                <div class="elementi_elenco">
                    <a href="main.php?page=messages_center&op=read&id_messaggio=<?php echo $row['id'] ?>">
                        <?php echo gdrcd_filter('out', substr(nl2br(gdrcd_bbcoder($row['testo'])), 0, 40)); ?>
                        ...
                    </a>
                </div>
            </td>
            <td>
                <div class="controlli_elenco">
                    <div class="controllo_elenco">
                        <!-- reply -->
                        <form action="main.php?page=messages_center<?php echo $isSentMessage ? '&op=inviati' : ''; ?>"
                            method="post">
    ...
    <div class="pulsanti_elenco">
        ...
        <form id="viewed_delete"
            action="main.php?page=messages_center<?php echo $isSentMessage ? '&op=inviati' : ''; ?>" method="post">
