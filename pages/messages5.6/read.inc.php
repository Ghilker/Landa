...
<div class="read_message_box">
    <div class="infos">
        ...
        <span class="body">
            <?php echo gdrcd_format_date($data_spedito) ?>
        </span>
        <span class="title">
            <?php echo ' ' . gdrcd_filter('out', $MESSAGE['interface']['messages']['time']) . ' '; ?>
        </span>
        <span class="body">
            <?php echo gdrcd_format_time($ora_spedito); ?>
        </span>
    </div>
    <div class="infos">
        <span class="title">
    ...
    <div class="infos">
        ...
        <span class="body">
            <?php echo gdrcd_filter('out', $MESSAGE['interface']['messages']['type']['options'][$record['tipo']]); ?>
        </span>
    </div>
    <div class="infos">
        <span class="title">
        ...
        <span class="body">
            <?php echo gdrcd_filter('out', $record['oggetto']); ?>
        </span>
    </div>
