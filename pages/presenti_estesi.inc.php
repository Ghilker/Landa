...
while ($record = gdrcd_query($result, 'fetch'))
{
	...
	*/
	...
	?> <td style="padding-left:15px; padding-right:15px; background-color: rgba(99, 109, 135, 0.15);"><a href="main.php?page=messages_center&newmessage=yes&reply_dest=('messaggi', 'Messaggi', 'popup.php?page=messages_center&newmessage=yes&reply_dest=<?= gdrcd_filter('url', $record['nome']) ?>">
