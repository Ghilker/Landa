 ...
 * ed al funzionamento di GDRCD. E' richiesto che vengano configurati i parametri alla voce "parametri di connessione" 
 * per eseguire una corretta connessione al database, altrimenti GDRCD non è in grado di operare. 
...
$PARAMETERS['database']['username'] = 'provalice'; //nome utente del database
$PARAMETERS['database']['password'] = '19ProvAlice93'; //password del database
$PARAMETERS['database']['database_name'] = 'my_provalice'; //nome del database
...
$PARAMETERS['administration']['rules']['access_level'] = ADMIN;
