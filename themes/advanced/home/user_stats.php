...
?> <strong>
	<?php echo gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['page_name']); ?>
</strong>
...
<table class="statistics">
	<tbody>
		<tr>
			...
			<td>
				<?php echo gdrcd_format_date($site_activity['date_of_activity']); ?>
			</td>
		</tr>
		<tr class="pair">
			<td class="label">
