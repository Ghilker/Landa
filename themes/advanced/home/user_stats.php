...
$master_users			= gdrcd_query("SELECT COUNT(nome) AS num FROM personaggio WHERE permessi = ". MASTER);
$admin_users			= gdrcd_query("SELECT COUNT(nome) AS num FROM personaggio WHERE permessi >= ". MODERATORE);
