            ...
            <div class="login_box">
               <div class="panels_box">
                  <div class="form_gioco">
                     <form name="do_login" id="do_login" action="login.php" method="post" <?php if
                        ($PARAMETERS['mode']['popup_choise'] == 'ON') { ?> onsubmit="check_login(); return false;"
                        <?php } ?>target="_top">
                        ...
                        <div class="form_submit"><input type="submit"
                              value="<?php echo $MESSAGE['homepage']['forms']['login']; ?>" /></div>
                     </form>
                  </div>
               </div>
            </div>
...
?>
                  ...
                  <div class="form_gioco">
                     <form name="do_login" action="index.php" method="post">
                        ...
                        <div class="form_submit"><input type="submit"
                              value="<?php echo $MESSAGE['homepage']['forms']['new_pass']; ?>" /><input type="hidden"
                              name="newp" value="changepass" /></div>
                     </form>
                  </div>
                  <?php } ?>
               </div>
