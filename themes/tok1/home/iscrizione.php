...
<form action = "<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>" method="post">
   <div class="form_submit">
     ...
     <input type="submit" value="<?php echo gdrcd_filter('out',$MESSAGE['register']['forms']['accept']); ?>" style="background-image: url('https://talesofkangei.altervista.org/themes/tok1/imgs/accettoedichiaro.png'); background-size: 239px 20px; height: 22px; width: 241px;"/>
   </div>
</form>
</div>
</div>
...
<form action = "index.php" method="post">
   <div class="form_submit">
     <input type="submit" value="<?php echo gdrcd_filter('out',$MESSAGE['register']['forms']['refuse']); ?>" style="background-image: url('https://talesofkangei.altervista.org/themes/tok1/imgs/rifiuto.png'); background-size: 71px 20px; height: 22px; width: 73px;" />
   </div>
</form>
</div>
</div>
...
<form action = "<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>" method="post">
   ...
   <div class="form_submit">
     ...
     <input type="submit" value="<?php echo gdrcd_filter('out',$MESSAGE['register']['forms']['next']); ?>" style="background-image: url('https://talesofkangei.altervista.org/themes/tok1/imgs/registra.png'); background-size: 71px 20px; height: 22px; width: 73px;" />
   </div>
...
<form action = "index.php" method="post">
   <div class="form_submit">
     <input type="submit" value="<?php echo gdrcd_filter('out',$MESSAGE['register']['forms']['abort']); ?>" style="background-image: url('https://talesofkangei.altervista.org/themes/tok1/imgs/annulla.png'); background-size: 71px 20px; height: 22px; width: 73px; margin-left: 50px" />
   </div>
</form>
</div></div>
</div>
...
<form action = "<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>" method="post">
   <div class="form_submit">
	 ...
	 <input type="hidden" name="car4" value="<?php echo gdrcd_filter('num',$_POST['car4']) ?>" />
	 <input type="hidden" name="car5" value="<?php echo gdrcd_filter('num',$_POST['car5']) ?>" />
     <input type="submit" value="<?php echo gdrcd_filter('out',$MESSAGE['register']['forms']['ok']);?>" style="background-image: url('https://talesofkangei.altervista.org/themes/tok1/imgs/conferma.png'); background-size: 77px 22px; height: 24px; width: 79px; margin-left: 50px" />
   </div>
</form>
<form action = "<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>" method="post">
   <div class="form_submit">
	 ...
	 <input type="hidden" name="car4" value="<?php echo gdrcd_filter('num',$_POST['car4']) ?>" />
	 <input type="hidden" name="car5" value="<?php echo gdrcd_filter('num',$_POST['car5']) ?>" />
     <input type="submit" value="<?php echo gdrcd_filter('out',$MESSAGE['register']['forms']['back']);?>" style="background-image: url('https://talesofkangei.altervista.org/themes/tok1/imgs/annulla.png'); background-size: 71px 20px; height: 22px; width: 73px; margin-left: 50px" />
   </div>
</form>
</div> </div>
<?php } ?>
...
gdrcd_query("INSERT INTO personaggio (nome, cognome, pass, data_iscrizione, email, sesso, id_razza, prestavolto, car0, car1, car2, car3, car4, car5, salute, salute_max, soldi, esperienza $lastpasschange_field) VALUES ('".trim(gdrcd_capital_letter(gdrcd_filter('in',$_POST['nome'])))."', '".trim(gdrcd_filter('in',$_POST['cognome']))."', '".gdrcd_encript($pass)."', NOW(), '".gdrcd_filter('in',$_POST['email'])."', '".gdrcd_filter('in',$_POST['genere'])."', ".gdrcd_filter('num',$_POST['razza']).", '".trim(gdrcd_filter('in',$_POST['prestavolto']))."', ".gdrcd_filter('num',$_POST['car0']).", ".gdrcd_filter('num',$_POST['car1']).", ".gdrcd_filter('num',$_POST['car2']).", ".gdrcd_filter('num',$_POST['car3']).", ".gdrcd_filter('num',$_POST['car4']).", ".gdrcd_filter('num',$_POST['car5']).", ".	gdrcd_filter('num',$PARAMETERS['settings']['max_hp']).", ".gdrcd_filter('num',$PARAMETERS['settings']['max_hp']).", ".gdrcd_filter('num',$PARAMETERS['settings']['first_money']).", ".gdrcd_filter('num',$PARAMETERS['settings']['first_px'])." $lastpasschange_value)");
