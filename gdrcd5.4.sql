...
VALUES
  ...
  (
    ...
    'Sopravvivenza',
    4,
    'Il personaggio Ã¨ in grado di procurarsi cibo e riparo all''aperto, con mezzi minimi.',
    -1
  ),
  (
    4,
  ...
  (
    ...
    'Cercare',
    5,
    'Il personaggio Ã¨ rapido ed efficace nel perquisire un ambiente in cerca di qualcosa.',
    -1
  ),
  (
    6,
  ...
  (
    ...
    'Cavalcare',
    2,
    'Il personaggio Ã¨ in grado di cavalcare animali addestrati a tale scopo.',
    -1
  ),
  (
    9,
  ...
  (
    ...
    'Armi bianche',
    0,
    'Il personaggio Ã¨ addestrato al combattimento con armi bianche, scudi e protezioni.',
    -1
  ),
  (
    11,
    'Armi da tiro',
    5,
    'Il personaggio Ã¨ addestrato all''uso di armi da diro o da lancio.',
    -1
  ),
  (
    12,
    'Lotta',
    0,
    'Il personaggio Ã¨ addestrato al combattimento senza armi.',
    -1
  ),
  (
    13,
  ...
  (
    ...
    'FurtivitÃ ',
    2,
    'Il personaggio Ã¨ in grado di muoversi ed agire senza dare nell''occhio, e di scassinare serrature.',
    -1
  ),
  (
    19,
    'VolontÃ ',
    4,
    'Il personaggio Ã¨ fortemente determinato e difficilmente si lascia persuadere o dissuadere.',
    -1
  );
...
--
INSERT INTO
  `araldo` (`id_araldo`, `tipo`, `nome`, `proprietari`)
VALUES
...
--
INSERT INTO
  `codtipogilda` (`descrizione`, `cod_tipo`)
VALUES
  ('Positivo', 1),
  ('Neutrale', 2),
  ('Negativo', 3);
...
--
INSERT INTO
  `codtipooggetto` (`cod_tipo`, `descrizione`)
VALUES
  (1, 'Animale'),
  (2, 'Vestito'),
  (3, 'Fiore - Pianta'),
...
VALUES
  (
    1,
    'Strada',
    'Via che congiunge la periferia al centro.',
    'Nella norma',
    '',
    1,
    'standard_luogo.png',
  ...
  (
    2,
    'Piazza',
    'Piccola piazza con panchine ed una fontana al centro.',
    'Nella norma',
    '',
    1,
    'standard_luogo.png',
...
VALUES
  (
    'Super',
    'User',
    '$P$BcH1cP941XHOf0X61wVWWjzXqcCi2a/',
    NULL,
    '2011-06-04 00:47:48',
    'email@domain.ext',
    4,
  ...
  (
    'Test',
    'Di FunzionaliÃ ',
    '$P$BUoa19QUuXsgIDlhGC3chR/3Q7hoRy0',
    NULL,
    '2011-06-04 00:47:48',
    'test@domain.ext',
    0,
