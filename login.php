...
else 
{
	...
	if (($login1 != '') && ($pass1 != ''))
	{
		...
		gdrcd_query("INSERT INTO log (nome_interessato, autore, data_evento, codice_evento, descrizione_evento) VALUES ('".gdrcd_filter('in',$_SESSION['login'])."','".((strlen($host) > 20) ? substr($host,0,20) : $host)."', NOW(), ".ERRORELOGIN." ,'".$_SERVER['REMOTE_ADDR']."')");
